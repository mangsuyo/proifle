...
export default function Root() {
  ...
  return (
    <div className="py-[10%] flex flex-col items-center root-page">
      <div className="flex flex-col items-center parent-effect">
        ...
        <p className="font-karla  leading-[1.2rem] text-[12px] text-gray text-center font-semibold md:w-[400px] ">
          I am studying computer engineering at Sejong Univ. <br /> I use React
          and Spring Boot to create web and app <br />I want to actively utilize
          technologies such as AI to find innovative solutions to social
          problems
        </p>
      </div>
      <div className="font-karla w-full mt-20 flex flex-col gap-3">
        {items.map((item) => (
          <Nav key={item.id} navItem={item} handleNavClick={handleNavClick} />
        ))}
      </div>
    </div>
  );
